<template>
    <div class="flex justify-end py-4 space-x-8 md:mx-10">
        ...
        <router-link to="/sms">
            <button class="px-4 py-2 text-white bg-green-500 rounded-lg tex-md">Send Bulky SMS</button>
        </router-link>
    </div>
    ...
    <table class="w-full table-fixed even:bg-gray-">
        ...
        <tbody class="bg-white">
            <tr v-for="(customer,i) in customers" :key="customer.id">
                ...
                <td class="flex items-center justify-center px-6 py-4 space-x-6 text-sm font-medium border-b border-gray-200">
