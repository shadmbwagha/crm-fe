<template>
    <div class="flex items-center justify-center h-screen -m-8 bg-slate-200">
        <div class="w-3/4 px-6 py-4 bg-white shadow-md">
            <div>
                <h1 class="mt-4 font-bold text-center text-md">Add Credit</h1>
                ...
                <div class="flex flex-col">
                    <div class="flex justify-between mt-8 space-x-6">
                        <div class="flex flex-col w-full space-y-2">
                            ...
                            <select class="px-4 py-2 border rounded-lg focus:outline-none" v-model="credit.customer_id">
...
export default {
    ...
    methods : {
        ...
        async createDebt(){
            await axios.post('/credit',  this.credit ).then((data)=> {
                this.$toast.success("succesfully added credit");
